    ...
    <nav className="fixed top-0 w-full lg:px-16 px-6 flex flex-wrap items-center lg:py-0 py-2 bg-amber-950 shadow-md z-50">
      ...
      >
        <ul className="flex flex-col pt-3 pb-3 gap-3 text-lg font-semibold px-4">
          <li><Link to="/spLayout" onClick={() => setIsMobileMenuOpen(false)} className="text-amber-950 hover:text-amber-700 transition-colors rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-amber-500" role="menuitem">Announcements</Link></li>
          <li><Link to="/spLayout/requests" onClick={() => setIsMobileMenuOpen(false)} className="text-amber-950 hover:text-amber-700 transition-colors rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-amber-500" role="menuitem">Request and Complaints</Link></li>
          <li><Link to="/spLayout/emergencyLogs" onClick={() => setIsMobileMenuOpen(false)} className="text-amber-950 hover:text-amber-700 transition-colors rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-amber-500" role="menuitem">Emergency Logs</Link></li>
          <li><Link to="/spLayout/faqs" onClick={() => setIsMobileMenuOpen(false)} className="text-amber-950 hover:text-amber-700 transition-colors rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-amber-500" role="menuitem">FAQs</Link></li>
          <li><Link to="/spLayout/feedback" onClick={() => setIsMobileMenuOpen(false)} className='text-amber-950 hover:text-amber-700 transition-colors rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-amber-500' role="menuitem">Feedback Logs</Link></li>
          <li><Link to="/spLayout/accountmanagement" onClick={() => setIsMobileMenuOpen(false)} className='text-amber-950 hover:text-amber-700 transition-colors rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-amber-500' role="menuitem">Account Management</Link></li>
          <li><Link to="/spLayout/visitorLogs" onClick={() => setIsMobileMenuOpen(false)} className='text-amber-950 hover:text-amber-700 transition-colors rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-amber-500' role="menuitem">Visitor Logs</Link></li>
          <li><Link to="/spLayout/officials" onClick={() => setIsMobileMenuOpen(false)} className='text-amber-950 hover:text-amber-700 transition-colors rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-amber-500' role="menuitem">Officials Board</Link></li>
           <li><Link to="/spLayout/profile" onClick={() => setIsMobileMenuOpen(false)} className='text-amber-950 hover:text-amber-700 transition-colors rounded-md px-2 py-1 focus:outline-none focus:ring-2 focus:ring-amber-500' role="menuitem">Profile</Link></li>
